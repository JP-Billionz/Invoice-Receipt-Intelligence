 ...
 *      runtime allowlist (parsed from the `BB_RETAILER_ALLOWLIST` env var,
 *      editable in the Render dashboard without a redeploy).
 *
 ...
 *
 * Pure / synchronous / no I/O — safe to use in tests, edge runtime, anywhere.
 */
...
/**
 * Parse a comma-separated allowlist string (as configured in env) into a
 * normalized array of lowercased host suffixes. Whitespace-tolerant, dedupes.
 */
