/**
 * Normalize a document number for cross-session duplicate detection.
 *
 * Mirrors the prototype's in-session dedup logic
 * (`App.tsx:189`): strip non-alphanumerics, uppercase. So `INV-2024/01`,
 * `inv2024-01`, and `INV 202401` all collide.
 *
