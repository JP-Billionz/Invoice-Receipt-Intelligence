 ...
 *
 * `Scan.fileBlob` is intentionally excluded — clients fetch the original
 * image via a dedicated route (`/api/scan/[scanId]/image`) so we don't ship
 * megabytes of base64 on every poll.
 */
